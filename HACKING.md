...
hidden if the `greetness-app_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `greetness-app_DEVELOPER_MODE` to the configure
...
Runs the executable target `greetness-app_exe`.
